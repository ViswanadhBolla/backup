    ...
    public class EmpController : Controller
    {
        ...
        public async Task<ActionResult> Create(Emp e)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                using (var response = await httpClient.PostAsync("https://localhost:7040/api/Employees", content))
                {
        ...
        public async Task<ActionResult> Update(int id)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                using (var response = await httpClient.GetAsync("https://localhost:7040/api/Employees/" + id))
                {
                    string apiResponse = await response.Content.ReadAsStringAsync();
        ...
        [HttpPost]
        public async Task<ActionResult> Update(Emp e)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                using (var response = await httpClient.PutAsync("https://localhost:7040/api/Employees/" + id, content1))
                {
                    string apiResponse = await response.Content.ReadAsStringAsync();
        ...
        public async Task<ActionResult> DeleteEmployee(Emp e)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                using (var response = await httpClient.DeleteAsync("https://localhost:7040/api/Employees/" + empid))
                {
                    string apiResponse = await response.Content.ReadAsStringAsync();
                }
            }
